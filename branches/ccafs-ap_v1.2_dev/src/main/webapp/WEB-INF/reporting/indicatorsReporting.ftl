          ...
          [#list indicatorReports as ir ]  
              ...
              [/#if] 
                ...
                <div class="thirdPartBlock">
                  ...
                  <span class="thirdPartBlock">${ir.target?c}</span>
                </div>
                ...
                <div class="thirdPartBlock">
                  ...
                  <div class="halfPartBlock">                    
                    [@customForm.input name="indicatorReports[${ir_index}].actual" type="text" i18nkey="reporting.indicators.actual" value="${ir.actual?c}" showTitle=false /]
                  </div>
                </div>
                ...
                <div class="thirdPartBlock">
                  ...
                  <div class="halfPartBlock">                    
                    ...
                    [@customForm.input name="indicatorReports[${ir_index}].nextYearTarget" type="text" i18nkey="reporting.indicators.actual" value="${ir.nextYearTarget?c}" showTitle=false /]
                  </div>
                </div>
