...
public class CaseStudiesSummaryAction extends BaseAction {
  ...
  public Map<Integer, String> getYearList() {
    ...
    years.put(0, getText("summaries.caseStudies.selectYear"));
  ...
  public String save() {
    ...
    List<CaseStudy> caseStudies = caseStudyManager.getCaseStudyListForSummary(leader, year, countries, types);
    ...
    caseStudyPdf = new CaseStudySummaryPdf("Case study report");
