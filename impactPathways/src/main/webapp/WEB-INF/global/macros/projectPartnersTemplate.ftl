  ...
  [#if leader?has_content]
      <div id="projectLeader" class="projectLeader clearfix">
          ...
          <div class="halfPartBlock"> 
            [@customForm.input name="preplanning.projectPartners.projectLeader" type="text" disabled=!canEdit i18nkey="preplanning.projectPartners.projectLeader" required=true /]
            <div class="searchUser">[@s.text name="form.buttons.searchUser" /]</div>
          </div>
          [#-- Project Coordinator --] 
          <div class="halfPartBlock">
            [@customForm.input name="preplanning.projectPartners.projectCoordinator" type="text" disabled=!canEdit i18nkey="preplanning.projectPartners.projectCoordinator"  /]
            <div class="searchUser">[@s.text name="form.buttons.searchUser" /]</div>
          </div> 
          [#-- Responsabilities --]
          [#if showResponsabilities]
