    ...
    <div class="fullContent">
      ...
      <div id="outcomeSynthesisBlock" class="">
        ...
        <div class="borderBox">
          ...
          <div class="fullPartBlock">
            [@customForm.textArea name="synthesis[${index}].synthesisReport" i18nkey="reporting.synthesis.synthesisByMog.synthesisReport" paramText="${mog.getComposedId()}" className="synthesisReport limitWords-150" required=canEdit editable=editable /]
          </div>
          [#-- Gender synthesis report for MOG --]
          <div class="fullPartBlock">
            [@customForm.textArea name="synthesis[${index}].synthesisGender" i18nkey="reporting.synthesis.synthesisByMog.genderSynthesisReport" paramText="${mog.getComposedId()}" className="genderSynthesisReport limitWords-150" required=canEdit editable=editable /]
          </div>
