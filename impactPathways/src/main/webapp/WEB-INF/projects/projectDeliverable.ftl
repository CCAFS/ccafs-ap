...
<section class="content">
  <div class="helpMessage">
    ...
    <p>
    [#if reportingCycle]
      [@s.text name="reporting.deliverables.help"][@s.param] <strong title="[@s.text name="reporting.deliverables.suitableRep.description" /]">[@s.text name="reporting.deliverables.suitableRep" /]</strong> [/@s.param][/@s.text]
    [#else]
      [@s.text name="planning.deliverables.help" /] <a href = [@s.url namespace="/" action='glossary'][/@s.url]>[@s.text name="planning.deliverables.help2" /]</a>
    [/#if]
