...
<section class="content">
  <div class="helpMessage">
    <img src="${baseUrl}/images/global/icon-help.png" /><p>[@s.text name="${currentSection}.projectLocation.help" /] </p>
  </div>
  ...
  <article class="halfContent" id="projectLocations">
    ...
    <div id="lessons" class="borderBox">
      ...
      <div class="fullBlock">
        <h6>[@customForm.text name="${currentSection}.project.locations.previousLessons" param="${reportingCycle?string(currentReportingYear,currentPlanningYear-1)}" /]:</h6>
