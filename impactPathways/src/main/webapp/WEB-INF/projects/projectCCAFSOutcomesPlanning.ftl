...
[#assign customJS = ["${baseUrl}/js/global/utils.js", "${baseUrl}/js/global/ipGraph.js", "${baseUrl}/js/projects/projectImpactPathwayPlanning.js"] /]
...
<section class="content">
  ...
  <article class="halfContent" id="activityImpactPathway">
    ...
    [#include "/WEB-INF/projects/projectIP-planning-sub-menu.ftl" /]
                          ...
                          <div class="indicatorTargets">
                            ...
                            [#list years as year]
                              ...
                              <div id="target-${year}" class="targetIndicator">
                                ...
                                <div class="textArea checkboxGroup vertical indicatorNarrative" >
