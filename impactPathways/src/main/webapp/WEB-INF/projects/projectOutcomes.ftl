    ...
    <div id="projectOutcomes" class="borderBox">
      ...
      <div class="fullPartBlock clearfix">
        ...
        [#list project.startDate?string.yyyy?number..midOutcomeYear?number-1 as year]
          ...
          <div class="fullBlock">
            [@customForm.textArea name="project.outcomes[${year?string}].comunication" className="limitWords-100" i18nkey="reporting.projectOutcomes.commEngagementOutcomes" required=true editable=editable/]
          </div>
