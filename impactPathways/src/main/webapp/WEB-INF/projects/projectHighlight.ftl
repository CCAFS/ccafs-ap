...
<section class="content">
  ...
  <article class="halfContent" id="projectHighlight">  
    ...
    <div id="highlight-information" class="borderBox clearfix">
      ...
      <div class="fullBlock">
        <div class="halfPartBlock">
          [@customForm.checkbox  name="highlight.global" className="isGlobal" i18nkey="reporting.projectHighlight.isGlobal" checked=(highlight.isGlobal)!false value="true" editable=editable/]
        </div>
      </div>
