...
<section class="content">
  <div class="helpMessage">
    <img src="${baseUrl}/images/global/icon-help.png" /><p>[@s.text name="${currentSection}.projectCcafsOutcomes.help" ][@s.param]${currentReportingYear}[/@s.param][/@s.text]</p>
  </div>
                            ...
                            [#list years as year]
                              ...
                              <div id="target-${year}" class="targetIndicator">
                                ...
                                <div class="fullBlock">
                                  ...
                                  [#-- 2. Cumulative target --]
                                  [#if (cycleYear lte year) && reportingCycle]
                                  <div class="thirdPartBlock">
