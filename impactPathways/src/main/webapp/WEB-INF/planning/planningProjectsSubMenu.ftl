    ...
    <li [#if currentStage == "activities"]${currCss}[/#if]>
      ...
      <ul>
        <li [#if currentSubStage == "activities" ] class="currentSection" [/#if]>
          <a href="[@s.url action='activities' includeParams='get'][@s.param name='projectID']${project.id?c}[/@s.param][/@s.url]">[@s.text name="menu.planning.submenu.projectActivities.activitiesList" /]</a>
        </li> 
      </ul>
    </li>
    <li [#if currentStage == "budget"]${currCss}[/#if]>
      ...
      <ul>
        <li [#if currentSubStage == "budgetByPartner"] class="currentSection" [/#if]>
          <a href="[@s.url action='budget' includeParams='get'][@s.param name='projectID']${project.id?c}[/@s.param][/@s.url]">[@s.text name="menu.planning.submenu.projectBudget.budgetByPartner" /]</a>
        </li>
