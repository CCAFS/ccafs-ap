...
<nav id="secondaryMenu"> 
  ...
  <ul> 
    ...
    <li><a [#if currentStage == "activities"]${currCss}[/#if] href="[@s.url action='activities' includeParams='get'][#if project??][@s.param name='projectID']${project.id}[/@s.param][/#if][/@s.url]">
