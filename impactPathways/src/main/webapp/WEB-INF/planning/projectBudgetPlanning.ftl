    ...
    [#if allYears?has_content]
      [#if project.leader?has_content]
        ...
        <div id="overhead" class="simpleBox">
          ...
          <div class="radios">
            <input type="radio" name="project.overhead.bilateralCostRecovered" value="true" id="isfullyInstitutionalCost_1" [#if project.overhead.bilateralCostRecovered]checked[/#if] /><label for="isfullyInstitutionalCost_1">[@s.text name="form.options.yes" /]</label>
            <input type="radio" name="project.overhead.bilateralCostRecovered" value="false" id="isfullyInstitutionalCost_0" [#if !project.overhead.bilateralCostRecovered]checked[/#if] /><label for="isfullyInstitutionalCost_0" >[@s.text name="form.options.no" /]</label>
          </div>
          <div class="overhead-block" style="display:${project.overhead.bilateralCostRecovered?string('none','block')}">
            <div class="fullPartBlock">
              [@customForm.input name="project.overhead.contractedOverhead" className="overHeadContractInput" i18nkey="planning.projectBudget.whatIsTheContracted" editable=editable/]
            </div>
            [#if canEdit]
