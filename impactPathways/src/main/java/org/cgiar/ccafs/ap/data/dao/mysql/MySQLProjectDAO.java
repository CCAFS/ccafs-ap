...
public class MySQLProjectDAO implements ProjectDAO {
  ...
  public List<Map<String, Object>> summaryGetAllCCAFSOutcomes(int year) {
    ...
    query.append(" (SELECT distinct ipr.acronym FROM ip_elements ie");
    ...
    query.append(" where ie.id in (ipe.id)) AS 'flagship' ");
  ...
  public List<Map<String, Object>> summaryGetInformationDetailPOWB(int year) {
    ...
    query.append("       'project_title', p.type AS project_type,  ");
