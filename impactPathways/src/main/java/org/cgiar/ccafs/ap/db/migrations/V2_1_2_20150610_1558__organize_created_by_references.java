...
public class V2_1_2_20150610_1558__organize_created_by_references implements JdbcMigration {

  private static Logger LOG = LoggerFactory.getLogger(V2_1_2_20150610_1558__organize_created_by_references.class);
  ...
  public void migrate(Connection connection) throws Exception {
    ...
    query.append("AND column_name = 'created_by' ");
    ...
    try {
      ...
      while (rs.next()) {
        ...
        query.append("UPDATE ");
        query.append(tableName);
        query.append(" SET created_by = ");
        query.append(" (SELECT user_id FROM employees WHERE id = created_by) ");
        ...
        query.append(" FOREIGN KEY (`created_by` ) ");
        ...
        LOG.info("Table {} was successfully updated", tableName);
      }
