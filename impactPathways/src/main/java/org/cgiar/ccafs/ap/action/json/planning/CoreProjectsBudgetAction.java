...
public class CoreProjectsBudgetAction extends BaseAction {

  private static Logger LOG = LoggerFactory.getLogger(CoreProjectsBudgetAction.class);
  ...
  @Inject
  public CoreProjectsBudgetAction(APConfig config, ProjectManager projectManager) {
    super(config);
  ...
  public String execute() {
    projects = projectManager.getCoreProjectsLeaders(flagshipID, regionID);
