...
public class V2_1_2_20150721_1630__create_history_table_for_project_mog_budgets implements JdbcMigration {

  private Flyway flyway;
  private static Logger LOG = LoggerFactory
    .getLogger(V2_1_2_20150721_1630__create_history_table_for_project_mog_budgets.class);

  public V2_1_2_20150721_1630__create_history_table_for_project_mog_budgets() {
    flyway = new Flyway();
  }
  ...
  public void migrate(Connection connection) throws Exception {
    ...
    String[] tableNames = {"project_mog_budgets"};
    ...
    try {
      ...
      stmnt.addBatch("ALTER TABLE project_mog_budgets DROP INDEX  UK_project_mog_budgets;");
