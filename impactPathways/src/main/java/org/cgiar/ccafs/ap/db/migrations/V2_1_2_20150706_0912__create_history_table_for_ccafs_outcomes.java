...
public class V2_1_2_20150706_0912__create_history_table_for_ccafs_outcomes implements JdbcMigration {

  private Flyway flyway;
  private static Logger LOG = LoggerFactory
    .getLogger(V2_1_2_20150706_0912__create_history_table_for_ccafs_outcomes.class);

  public V2_1_2_20150706_0912__create_history_table_for_ccafs_outcomes() {
    flyway = new Flyway();
  }
  ...
  public void migrate(Connection connection) throws Exception {
    ...
    String[] tableNames = {"ip_project_contributions", "ip_project_indicators"};
