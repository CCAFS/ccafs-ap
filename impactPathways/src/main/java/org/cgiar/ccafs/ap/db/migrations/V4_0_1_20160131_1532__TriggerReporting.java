...
public class V4_0_1_20160131_1532__TriggerReporting implements JdbcMigration {

  private static Logger LOG = LoggerFactory.getLogger(V4_0_1_20160131_1532__TriggerReporting.class);

  @Override
  public void migrate(Connection connection) throws Exception {
    Statement statement = connection.createStatement();
    String[] tableNames = {"cross_cutting_contribution", "project_highligths", "other_contributions",
      "project_leverage", "project_next_user", "cases_studies"};
