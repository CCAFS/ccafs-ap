...
public class EditDeliverablePlanningInterceptor extends AbstractInterceptor {

  private static Logger LOG = LoggerFactory.getLogger(EditDeliverablePlanningInterceptor.class);
  ...
  @Inject
  public EditDeliverablePlanningInterceptor(SecurityContext securityContext, ProjectManager projectManager) {
  ...
  public String intercept(ActionInvocation invocation) throws Exception {
    ...
    EditProjectPlanningInterceptor.setPermissionParameters(invocation, securityContext, projectManager);
