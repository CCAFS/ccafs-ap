...
public class V4_0_1_20160208_1420__TriggerProjectOtherContribution implements JdbcMigration {

  private static Logger LOG = LoggerFactory.getLogger(V4_0_1_20160208_1420__TriggerProjectOtherContribution.class);

  @Override
  public void migrate(Connection connection) throws Exception {
    Statement statement = connection.createStatement();
    String[] tableNames = {"other_contributions"};
