...
public class ProjectBudgetValidator extends BaseValidator {
  ...
  @Inject
  public ProjectBudgetValidator(ProjectValidator projectValidator, BudgetValidator budgetValidator) {
