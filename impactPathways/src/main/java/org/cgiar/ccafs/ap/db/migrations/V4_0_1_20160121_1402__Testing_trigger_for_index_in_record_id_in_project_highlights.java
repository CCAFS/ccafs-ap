...
public class V4_0_1_20160121_1402__Testing_trigger_for_index_in_record_id_in_project_highlights
  implements JdbcMigration {

  private static Logger LOG =
    LoggerFactory.getLogger(V4_0_1_20160121_1402__Testing_trigger_for_index_in_record_id_in_project_highlights.class);

  @Override
  public void migrate(Connection connection) throws Exception {
    Statement statement = connection.createStatement();
    String[] tableNames = {"project_highligths"};
