...
public class V4_0_1_20160202_1412__TriggerReportingOldTables implements JdbcMigration {

  private static Logger LOG = LoggerFactory.getLogger(V4_0_1_20160202_1412__TriggerReportingOldTables.class);

  @Override
  public void migrate(Connection connection) throws Exception {
    Statement statement = connection.createStatement();
    String[] tableNames = {"activities", "deliverables", "project_outcomes", "ip_project_indicators",
      "ip_project_contribution_overviews", "projects"};
