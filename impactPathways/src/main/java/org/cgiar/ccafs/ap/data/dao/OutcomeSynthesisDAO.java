...
import org.cgiar.ccafs.ap.data.dao.mysqlhiberate.OutcomeSynthesisMySQLDAO;
...
@ImplementedBy(OutcomeSynthesisMySQLDAO.class)
public interface OutcomeSynthesisDAO {
