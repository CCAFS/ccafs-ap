...
public class V2_1_2_20150714_1148__create_history_table_for_project_contribution_overview implements JdbcMigration {

  private Flyway flyway;
  private static Logger LOG = LoggerFactory
    .getLogger(V2_1_2_20150714_1148__create_history_table_for_project_contribution_overview.class);

  public V2_1_2_20150714_1148__create_history_table_for_project_contribution_overview() {
    flyway = new Flyway();
  }
  ...
  public void migrate(Connection connection) throws Exception {
    ...
    String[] tableNames = {"ip_project_contribution_overviews"};
    ...
    try {
      ...
      stmnt.addBatch("ALTER TABLE ip_project_contribution_overviews DROP INDEX  UK_ip_project_contribution_overviews;");
