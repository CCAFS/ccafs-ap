...
public class V2_1_2_20150805_07559__update_history_table_for_projects implements JdbcMigration {

  private static Logger LOG = LoggerFactory.getLogger(V2_1_2_20150805_07559__update_history_table_for_projects.class);
  private Flyway flyway;

  public V2_1_2_20150805_07559__update_history_table_for_projects() {
    flyway = new Flyway();
  }
  ...
  public void migrate(Connection connection) throws Exception {
    ...
    try {
      ...
      stmnt.execute("ALTER TABLE `projects` DROP COLUMN `is_cofinancing` ;");
