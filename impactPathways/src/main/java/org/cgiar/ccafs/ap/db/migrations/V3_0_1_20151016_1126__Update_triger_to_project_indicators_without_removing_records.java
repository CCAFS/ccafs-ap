...
public class V3_0_1_20151016_1126__Update_triger_to_project_indicators_without_removing_records
  implements JdbcMigration {

  private static Logger LOG =
    LoggerFactory.getLogger(V3_0_1_20151016_1126__Update_triger_to_project_indicators_without_removing_records.class);

  @Override
  public void migrate(Connection connection) throws Exception {
    Statement statement = connection.createStatement();
    String[] tableNames = {"ip_project_indicators"};
    ...
    try {
      ...
      for (String tableName : tableNames) {
        try {
          ...
          // Update triggers with the new column added in the SQL:
          // V3_0_1_20151016_1011__Adding_new_column_in_ip_project_indicators_table.sql.
