...
public class AddCofoundedProjectPlanningAction extends BaseAction {

  private static Logger LOG = LoggerFactory.getLogger(AddCofoundedProjectPlanningAction.class);
  ...
  @Inject
  public AddCofoundedProjectPlanningAction(APConfig config, ProjectManager projectManager,
