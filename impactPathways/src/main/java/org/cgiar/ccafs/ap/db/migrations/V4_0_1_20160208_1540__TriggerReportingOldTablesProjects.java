...
public class V4_0_1_20160208_1540__TriggerReportingOldTablesProjects implements JdbcMigration {

  private static Logger LOG = LoggerFactory.getLogger(V4_0_1_20160208_1540__TriggerReportingOldTablesProjects.class);

  @Override
  public void migrate(Connection connection) throws Exception {
    Statement statement = connection.createStatement();
    String[] tableNames = {"projects"};
