...
public class V2_1_2_20150710_1603__create_history_table_for_project_deliverables implements JdbcMigration {

  private Flyway flyway;
  private static Logger LOG = LoggerFactory
    .getLogger(V2_1_2_20150710_1603__create_history_table_for_project_deliverables.class);

  public V2_1_2_20150710_1603__create_history_table_for_project_deliverables() {
    flyway = new Flyway();
  }
  ...
  public void migrate(Connection connection) throws Exception {
    ...
    String[] tableNames = {"deliverables", "deliverable_partnerships", "next_users"};
