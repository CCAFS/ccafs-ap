 ...
 * in order to update the options showed in the MOG select list.
 * 
...
function selectMidOutcomeEvent(event){
  ...
  if(outcomeSelectedVal == -1) return;
...
/**
 * This function load the MOGs which contributes to 
 * the midOutcome identified by the value received
 * as parameter and put them in the interface as a 
 * list of checkboxes
 * 
...
/**
 * This function load the indicators which belongs to 
 * the midOutcome identified by the value received as parameter 
 * and put them in the interface as a list of checkboxes
 * 
 * @param midOutcomeID - midOutcome identifier
 * @param programID - the program to which the midOutcome belongs to
 * @param $indicatorsBlock - a jquery object that contains the block 
 *                          where the indicators should be append
 */
