...
import org.cgiar.ccafs.ap.data.manager.impl.DeliverableScoreManagerImpl;
...
@ImplementedBy(DeliverableScoreManagerImpl.class)
public interface DeliverableScoreManager {
   ...
   * @return Map with the information
   */
